...
# Funktion för att visa alla lediga rum och tider för de kommande fem vardagarna
...
# Uppdaterad huvudmeny för bokningssystemet
def boka_rum_terminal():
    print("Välkommen till bokningssystemet!")
    while True:
        try:
            visa_lediga_rum_vecka()  # Visa lediga rum för de kommande fem vardagarna
...
# Funktion för att boka rum via API:t
